"""Command-line access to the pending-review queue.
    ...
    python -m segosight.review list [--type TYPE] [--limit N]
    python -m segosight.review show INSIGHT_ID
    python -m segosight.review approve INSIGHT_ID --reviewer NAME [--note TEXT]
    python -m segosight.review reject  INSIGHT_ID --reviewer NAME [--note TEXT]
...
from .curated.extraction import PENDING, TABLE
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="segosight.review")
