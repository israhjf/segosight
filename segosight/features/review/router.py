...
from segosight.features.review.curated import promotion
from segosight.features.review.curated.extraction import PENDING, TABLE as INSIGHTS
from segosight.features.review.llm import MAX_LLM_CONFIDENCE  # noqa: F401  (documents the cap)
from segosight.app.dependencies import get_connection, write_lock
from segosight.app.schemas import Decision, DecisionResult, ReviewItem
