...
from segosight.features.chemistry.programs import Config, load_config
...
def attach_prose(
    ...
    * a risk that exists *only* in prose -- a broken promise, a written concern
    ...
    anything.
    """
    from segosight.features.review.curated.extraction import PENDING as PENDING_REVIEW, TABLE as INSIGHTS
